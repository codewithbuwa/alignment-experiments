...
\begin{figure}[H]
    ...
    \caption{Sensitivity grid: final sigma vs. supervision strength.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Training dynamics for the tracked alpha (single vs mixture).}
\end{figure}
